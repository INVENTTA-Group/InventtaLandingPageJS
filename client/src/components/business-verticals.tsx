...
import { businessVerticals, getFeaturedVerticals, getOtherVerticals } from "@/data/businessVerticals";
import BusinessVerticalCard from "@/components/sections/BusinessVerticalCard";
...
export default function BusinessVerticals() {
  ...
  const handleVerticalClick = (vertical: any) => {
